...
import {requestDialogReset, requestDialogStop} from '@src/requests';
...
export default {
  ...
  methods: {
    ...
    async endCall() {
      await requestDialogReset({courseId: this.$route.params.courseId});
      await requestDialogStop({courseId: this.$route.params.courseId});
