...
const routes = [
    ...
    {
        path: '/auth/register', component: RegisterPage, name: PAGE_NAMES.register,
        beforeEnter: checkAuth
    },
    {
        path: '/courses', component: CoursesPage, name: PAGE_NAMES.courses,
        beforeEnter: checkAuth
    },
    {
        path: '/courses/:courseId', component: CurrentCoursePage, name: PAGE_NAMES.courseItem,
        beforeEnter: checkAuth
    },
];
